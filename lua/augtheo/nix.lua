...
nixInfo.lze.register_handlers({
	...
	-- This must run after the handlers above because it relies on their enabled state.
	nixInfo.lze.lsp,
})
...
nixInfo.lze.h.lsp.set_ft_fallback(function(name)
	...
	if lspcfg then
		local loaded, cfg = pcall(dofile, lspcfg .. "/lsp/" .. name .. ".lua")
		return (loaded and cfg or {}).filetypes or {}
	end
