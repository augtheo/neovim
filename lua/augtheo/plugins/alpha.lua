        ...
        local buttons = {
            ...
            val = {
                ...
                dashboard.button(
                    ...
                    [[:lua require("augtheo.plugins.telescope-utils").find_files() <cr>]]
                ),
                dashboard.button(
                    "SPC f o",
                    icons.ui.Recent .. " Find Recent",
                    [[:lua require("augtheo.plugins.telescope-utils").oldfiles() <cr>]]
                ),
                dashboard.button(
                    "SPC s g",
                    " " .. " Find Text",
                    [[:lua require("augtheo.plugins.telescope-utils").live_grep() <cr>]]
                ),
